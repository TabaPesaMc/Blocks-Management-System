    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='STOCK_MANAGEMENT_APP.category')),
            ],
        ),
        migrations.CreateModel(
            name='StockHistory',
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='STOCK_MANAGEMENT_APP.category')),
                ('old_price', models.ForeignKey(blank=True, default='1', null=True, on_delete=django.db.models.deletion.CASCADE, to='STOCK_MANAGEMENT_APP.Stock')),
            ],
        ),
        migrations.CreateModel(
            name='profile',
